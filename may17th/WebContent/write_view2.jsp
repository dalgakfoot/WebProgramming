...
<div align="center">
	...
	<table class="table">
		...
		<tr align="center">
			<td style="padding-top: 85px; border-right: 1px solid gray;">내용</td><td style="color: black;"><textarea name="content" rows="10" cols="100"></textarea></td>
		</tr>
		<tr>
			<td colspan="2" align="right" style="padding-right: 40px;">
				...
				<input style="color: black;" type="submit" value="저장"> 
			</td>
		</tr>
	</table>	
	</form>
